...
def adam(x, dx, config=None):
    ...
    #next_x = x - first_unbias*config['learning_rate'] / (np.sqrt(second_unbias) + config['epsilon'])
    #config['m'] = first_moment
    #config['v'] = second_moment
    
    beta1, beta2, m, v, t = config['beta1'], config['beta2'], config['m'], config['v'], config['t']
